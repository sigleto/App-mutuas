    ...
    >
      <View style={styles.centeredView}>
        ...
        <Text style={styles.modalText}>
          ...
          <Text style={styles.modalText}>
            A continuación se calculará la diferencia entre los tipos de gravamen asumiendo que no existen más rendimientos significativos en el ejercicio que la pensión. No se tendrá en cuenta para dicho cálculo más circunstancias personales que los datos de edad y minusvalía aportados por el usuario. Tenga en cuenta que esto es tan sólo un cálculo aproximado.
          </Text>
