  ...
  return (
    <ScrollView style={styles.container}>
      <SharedElement id="elementId">
        ...
        "Cambios a esta Política de privacidad\n\nPodemos actualizar nuestra Política de privacidad de vez en cuando. Por lo tanto, se le recomienda revisar esta página periódicamente para ver si hay cambios. Le notificaremos cualquier cambio publicando la nueva Política de Privacidad en esta página. Esta política es efectiva a partir del 2023-30-10\n\n" +
