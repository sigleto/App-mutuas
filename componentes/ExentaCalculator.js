...
const ExentaCalculator = ({
  ...
  suspension1,
  suspension2,
  setParteExenta, // Esta es la función que ya recibes como prop
  onCalcular // Recibimos la función onCalcular
}) => {
  const calcular = () => {
    ...
    setParteExenta("Parte exenta: " + cantidadExenta);
    <Text style={styles.resultado}>Parte exenta: {setParteExenta}</Text>
    onCalcular(); // Llamamos a la función onCalcular para mostrar los campos adicionales
  };
...
export default ExentaCalculator;